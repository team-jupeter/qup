...
t1s = [%OpenT1{input: hankyung_gab_public_address, amount: transaction_1.output_amount, output: hong_public_address}]
hong_entity_BS = change(hong_entity_BS) |> \
...
# case Enum.at(hong_t1s, 0).output == hong_public_address do:
    ...
    t1s = [%OpenT1{input: hong_public_address, output: hong_public_address, amount: residual_amount}]
