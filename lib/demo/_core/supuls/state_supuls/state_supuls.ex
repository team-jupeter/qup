defmodule Demo.StateSupuls do
  ...
  def minus_t1_balance(%StateSupul{} = state_supul, %{amount: amount}) do
    minus_t1_balance = Decimal.sub(state_supul.t1_balance, amount)
    update_state_supul_gab(state_supul, %{t1_balance: minus_t1_balance})
  end

  def plus_t1_balance(%StateSupul{} = state_supul, %{amount: amount}) do
    plus_t1_balance = Decimal.add(state_supul.t1_balance, amount)
    update_state_supul_gab(state_supul, %{t1_balance: plus_t1_balance})
  end
  ...
  defp make_hash(state_supul, %{incoming_hash: incoming_hash, sender: _supul_id}) do
