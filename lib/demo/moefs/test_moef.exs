...
moef_BS = Ecto.build_assoc(moef_FR, :gov_balance_sheet, %GovBalanceSheet{monetary_unit: "KRW", t1s: [%{input: korea.id, output: moef.id, amount: Decimal.from_float(10000000.00)}], cashes: [%{KRW: Decimal.new(10000000000.00)}]}) |> Repo.insert!
...
new_t1s = Enum.map(moef_BS.t1s, fn elem ->
