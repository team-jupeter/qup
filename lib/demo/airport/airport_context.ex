defmodule Demo.AirportContext do
  @moduledoc """
  ...
  def upsert_passenger_transactions(passenger, transaction_ids) when is_list(transaction_ids) do
    transactions =
      Transaction
    ...
    with {:ok, _struct} <-
           passenger
           |> passenger.changeset_update_transactions(transactions)
           |> Repo.update() do
