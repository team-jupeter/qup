defmodule Demo.Airport do
  ...
  def arrive(%{airport: airport, airline: airline, number_of_passengers: number_of_passengers}) when is_binary(airline) and is_integer(number_of_passengers) do
  ...
  def depart(%{airport: airport, airline: airline, number_of_passengers: number_of_passengers}) when is_binary(airline) and is_integer(number_of_passengers) do
