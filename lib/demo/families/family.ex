defmodule Demo.Families.Family do
  ...
  schema "families" do
    field :family_code, :string #? add charater "f" to the email of the house holder.
    field :nationality, :string
    field :auth_code, :string 
    field :address, :string

    field :house_holder_name, :string #? the name of the house_holder
    field :house_holder_email, :string #? the email of the house_holder
